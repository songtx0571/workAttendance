...
<head>
    ...
    <style>
        * {
        ...
        .addateAchievement .table tr {
            height: 65px;
            line-height: 65px;
        }

        .addateAchievement .table tr td:first-of-type {
            width: 30%;
            text-align: right;
            padding-right: 10px;
            box-sizing: border-box;
        ...
        .addateAchievement .table tr td input {
            width: 100%;
            height: 40px;
        ...
        /*添加考核项可选内容*/
        .showAddAteAchievement {
            width: 100%;
            padding: 10px;
            box-sizing: border-box;
        }

        .warp .addateAchievement .layui-table-cell .layui-form-checkbox[lay-skin=primary] {
            top: 5px;
        }
...
<div class="warp">
        ...
        <ul class="showAchievementList">
            ...
            <li>
                <button class="layui-btn layui-btn-sm"
                        style="margin-left: 50px;float: left;height: 38px;margin-right: 5px;"
                        onclick="monthUpBtn('yeji')">&nbsp;&nbsp;&lt;&lt;&nbsp;&nbsp;
                </button>
                <div class="layui-inline" style="margin-bottom: 10px;float:left;">
                    <div class="layui-input-inline">
                ...
                <button class="layui-btn layui-btn-sm" style="float: left;height: 38px;margin-left: 5px;"
                        onclick="monthDownBtn('yeji')">&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;
                </button>
            </li>
        </ul>
        <ul class="showAchievementList">
            <li>
                <button class="layui-btn" onclick="showAddateAchievement()" id="addBtnAchievementDiv">添加考核项</button>
            </li>
            <li>
                <button class="layui-btn layui-btn-normal" style="float: left;margin-left: 10px;"
                        onclick="switchBehavior('achievement')">切换
                </button>
            </li>
            <li>
            ...
            <li>
                <div class="layui-inline" style="margin-bottom: 10px;float:left;display: none;margin-left: 5px"
                     id="hideTimeDiv">
                    <div class="layui-input-inline">
            ...
            <li>
                <button class="layui-btn" style="float: left;display: none;margin-left: 10px;" id="copyTimeBtn"
                        onclick="copyTimeOk()">确定复制
                </button>
            </li>
        </ul>
    ...
    <div class="addateAchievement">
        <div class="layui-tab" lay-filter="testTab">
            <ul class="layui-tab-title">
                <li class="layui-this" lay-id="11">手动添加</li>
                <li lay-id="22">批量添加</li>
            </ul>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center;width: 100%;">
                                <button class="layui-btn" onclick="addAteAchievement()">确定</button>
                                <button class="layui-btn" onclick="cancel1()">取消</button>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="layui-tab-item">
                    <div class="showAddAteAchievement">
                        <table id="demoAdd" lay-filter="testAdd"></table>
                        <script type="text/html" id="barDemoAdd">
                            <a class="layui-btn layui-btn-xs" lay-event="deleteAchievement" id="deleteAchievement">删除</a>
                        </script>
                    </div>
                    <div style="text-align: center">
                        <button class="layui-btn" onclick="addAteAchievementTable()">确定</button>
                        <button class="layui-btn" onclick="cancel1()">取消</button>
                    </div>
                </div>
            </div>
    ...
    <div class="showBehaviorDiv">
        ...
        <ul class="showBehaviorList">
            ...
            <li>
                ...
                <button class="layui-btn layui-btn-sm" style="float: left;height: 38px;margin-left: 5px;"
                        onclick="monthDownBtn('xingwei')">&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;
                </button>
            </li>
            <li>
                <button class="layui-btn layui-btn-normal" style="float: left;margin-left: 10px;"
                        onclick="switchBehavior('behavior')">切换
                </button>
            </li>
        </ul>
        <div class="behaviorTable">
            <table style="width: 100%;border: 1px solid #ccc;collapse: 0;text-align: center">
                ...
                <tr>
                    <td>净绩效</td>
                    <td colspan="5"><input type="text" id='netPerformance' name="netPerformance" disabled="disabled">
                    </td>
                    <td colspan="4">综合绩效</td>
                    <td><input type="text" id="comprehensivePerformance" name="comprehensivePerformance"
                ...
                <tr>
                    <td colspan="11">
                        <button class="layui-btn hideBtn" onclick="updBehavior()">确定</button>
    ...
    <div class="showSetSign">
        ...
        <p style="font-size: 20px;font-weight: bold;text-align: center;line-height: 116px;color: red;display: none;"
           id="setSignP">无业绩！</p>
