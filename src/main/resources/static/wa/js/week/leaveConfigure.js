    ...
    layui.use(['table',"form"], function() {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'data', title: '数值', event: 'setSign', style: 'cursor: pointer;', sort: true, edit: 'text'}
                , {field: 'created', title: '创建时间', sort: true}
                , {fixed: '', title: '状态', toolbar: '#barDemo11', align: 'center ', width: 250}
                , {fixed: '', title: '操作', toolbar: '#barDemo12', align: 'center ', width: 250}
            ]]
