...
function addBtnOk() {
    ...
    leaveData.startTime = $("#test4").val()+" "+$("#test5").val();
    leaveData.endTime = $("#test2").val()+" "+$("#test3").val();
    ...
    if (leaveData.startTime.length < 18) {
        $("#addStartTimeSpan").css("display", "block");
        return;
    }
    if (leaveData.endTime.length < 18) {
